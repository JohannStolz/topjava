...
public class SpringMain {
    public static void main(String[] args) {
        ...
        try (ConfigurableApplicationContext tunableAppCtx = new ClassPathXmlApplicationContext()) {
            ConfigurableEnvironment environment = tunableAppCtx.getEnvironment();
            environment.addActiveProfile(Profiles.DATAJPA);
            environment.addActiveProfile(Profiles.POSTGRES_DB);
            tunableAppCtx.refresh();
